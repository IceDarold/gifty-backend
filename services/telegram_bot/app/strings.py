STRINGS = {
    "ru": {
        ...
        "scraping_workers_title": "🚦 *Активные воркеры ({count}):*",
        "scraping_broken_sources": "🚨 *Требуют внимания:*",
    ...
    "en": {
        ...
        "scraping_workers_title": "🚦 *Active Workers ({count}):*",
        "scraping_broken_sources": "🚨 *Needs Attention:*",
