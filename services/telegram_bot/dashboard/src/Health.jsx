...
const Health = () => {
    ...
    useEffect(() => {
        const fetchHealth = async () => {
            try {
                const res = await api.get('/internal/health');
                setHealth(res.data);
            } catch (err) {
