...
1.  [FastAPI Tutorial (User Guide)](https://fastapi.tiangolo.com/tutorial/) — лучший туториал в мире Python. Серьезно.
2.  [SQLAlchemy 2.0 Unified Tutorial](https://docs.sqlalchemy.org/en/20/tutorial/index.html) — про новый стиль запросов.
3.  [Docker для новичков](https://docker-curriculum.com/) — если контейнеры все еще магия.
