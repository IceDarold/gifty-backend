...
### Регистрация
Для входа в систему администрирования вам понадобится **секретный ключ** или **приглашение** от текущего администратора.

1.  Найдите бота в Telegram и нажмите **/start**.
2.  Если у вас есть секретный ключ (из `.env` файла), введите:
    `/start <ваш_секретный_ключ>`
3.  Если вас пригласил коллега, используйте пароль из приглашения:
