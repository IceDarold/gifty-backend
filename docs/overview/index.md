...
1.  **Парсинг данных**: Сбор информации о товарах с сайтов-доноров.
    *   👉 **[Архитектура парсинга](../parsing/architecture.md)**
    *   👉 **[Как добавить новый парсер](../parsing/guide.md)**
2.  **Обработка и обогащение**: Использование LLM для оценки "подарочности" товара и автоматической привязки к категориям.
    *   👉 **[Gifty Intelligence API](../recommendation/intelligence_api.md)**
3.  **Векторизация и Рекомендации**: Превращение описаний в векторы и подбор на основе анкеты.
    *   👉 **[Теория GUTG](../recommendation/theory.md)**
    *   👉 **[Алгоритмы рекомендаций](../recommendation/overview.md)**
4.  **Интерфейсы**: 
    *   **Web App**: Фронтенд для подбора подарков.
    *   **Telegram Admin Bot**: Управление и мониторинг. 
        *   👉 **[Гайд пользователя](../analytics_monitoring/telegram_bot/user_guide.md)**
        *   👉 **[Внутреннее устройство (Internals) (New!)](../analytics_monitoring/telegram_bot/internals.md)**
...
👉 **[Гайд по Analytics API](../analytics_monitoring/dashboard.md)**
