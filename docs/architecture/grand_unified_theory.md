...
2.  **The Aesthetic (Style Language Match)**
    ...
    *   *Dual Role*:
        *   **Как драйвер**: Подарки "ради красоты" (декор, арт, аксессуары), которые дополняют их сцену.
        *   **Как фильтр**: Обязательное условие для любых других подарков (пылесос должен быть красивым).
    *   *Examples*: Керамика в тон интерьера (Driver), черный матовый мультитул (Filter).
